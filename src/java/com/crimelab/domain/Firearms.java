...
public class Firearms {
    ...
    private String timeDateIncident;
    ...
    public Firearms(String division, String reportNo, String caseType, String suspect, String victim, String timeDateIncident,
            String placeOfIncident, String investigator, String caseStatus, String timeDateReceived, String requestingParty, 
            String specimenSubmitted, String purposeOfLabExam, String findings, String conclusion, String remarks, String timeDateCompleted, String examinerName,
    ...
    /**
     * @return the timeDateIncident
     */
    public String getTimeDateIncident() {
        return timeDateIncident;
    }

    /**
     * @param timeDateIncident the timeDateIncident to set
     */
    public void setTimeDateIncident(String timeDateIncident) {
        this.timeDateIncident = timeDateIncident;
    }
    ...
    /**
     * @param placeOfIncident the placeOfIncident to set
     */
